...
circle0.color = 0b1111100000011111
circle1.color = 0b1111111111100000

physics_circle0 = Test()
physics_circle1 = Test()

physics_circle0.collision_shape = CircleCollisionShape2D(10)
physics_circle1.collision_shape = CircleCollisionShape2D(10)

physics_circle0.add_child(circle0)
physics_circle1.add_child(circle1)

physics_circle0.position = Vector2(64-32, 64)
physics_circle1.position = Vector2(64+32, 64)

# physics_circle0.gravity_scale = Vector2(0, 0)
# physics_circle1.gravity_scale = Vector2(0, 0)

physics_circle0.bounciness = 1
physics_circle1.bounciness = 1

physics_circle0.velocity = Vector2(0.5, 0)
physics_circle1.velocity = Vector2(-0.5, 0)
