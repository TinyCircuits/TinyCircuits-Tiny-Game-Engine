...
top_wall_rect.width = 128
top_wall_rect.height = 5
bottom_wall_rect.width = 128
...
top_wall_physics.collision_shape = RectangleCollisionShape2D(128, 5)
bottom_wall_physics.collision_shape = RectangleCollisionShape2D(128, 5)
...
left_wall_physics.position = Vector2(0, 128/2)
right_wall_physics.position = Vector2(128, 128/2)
...
texture = TextureResource("text.bmp", True)
