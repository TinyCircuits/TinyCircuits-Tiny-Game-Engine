...
void engine_physics_rectangle_2d_node_update(engine_physics_rectangle_2d_node_class_obj_t *self){
    ...
    float rotation = mp_obj_get_float(self->rotation);
...
mp_obj_t physics_rectangle_2d_node_class_del(mp_obj_t self_in){
    ...
    engine_physics_rectangle_2d_node_class_obj_t *node = node_base->node;
...
bool physics_rectangle_2d_load_attr(engine_node_base_t *self_node_base, qstr attribute, mp_obj_t *destination){
    ...
    engine_physics_rectangle_2d_node_class_obj_t *self = self_node_base->node;
...
bool physics_rectangle_2d_store_attr(engine_node_base_t *self_node_base, qstr attribute, mp_obj_t *destination){
    ...
    switch(attribute){
        ...
        case MP_QSTR_width:
            ...
            engine_physics_rectangle_2d_node_update(self);
            return true;
        break;
        case MP_QSTR_height:
...
mp_obj_t physics_rectangle_2d_node_class_new(const mp_obj_type_t *type, size_t n_args, size_t n_kw, const mp_obj_t *args){
    ...
    enum arg_ids {child_class, position, width, height, velocity, acceleration, rotation, mass, bounciness, dynamic, solid, gravity_scale};
    ...
    engine_physics_rectangle_2d_node_class_obj_t *physics_2d_node = m_malloc(sizeof(engine_physics_rectangle_2d_node_class_obj_t));
    node_base->node = physics_2d_node;
    node_base->attr_accessor = node_base;

    physics_2d_node->position = parsed_args[position].u_obj;
    physics_2d_node->width = parsed_args[width].u_obj;
    physics_2d_node->height = parsed_args[height].u_obj;
