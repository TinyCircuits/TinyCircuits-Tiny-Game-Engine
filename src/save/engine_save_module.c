...
STATIC mp_obj_t engine_save_set_location(mp_obj_t location){
    ...
    engine_save_set_file_location(str, str_len, 256);
...
//         uint32_t len = snprintf(buffer, BUFFER_LENGTH_MAX, "%ld", mp_obj_get_int(obj));
//         engine_file_write(file_index, buffer, len);
//     }else if(mp_obj_is_float(obj)){
//         engine_file_write(file_index, "TYPE=FLT\n", 9);
//         uint32_t len = snprintf(buffer, BUFFER_LENGTH_MAX, "%.09f", mp_obj_get_float(obj));
//         engine_file_write(file_index, buffer, len);
...
//         len = snprintf(buffer, BUFFER_LENGTH_MAX, "%.09f ", ((mp_obj_float_t)((vector2_class_obj_t*)obj)->x).value);
//         engine_file_write(file_index, buffer, len);

//         len = snprintf(buffer, BUFFER_LENGTH_MAX, "%.09f", ((mp_obj_float_t)((vector2_class_obj_t*)obj)->y).value);
//         engine_file_write(file_index, buffer, len);
...
//         len = snprintf(buffer, BUFFER_LENGTH_MAX, "%.09f ", ((mp_obj_float_t)((vector3_class_obj_t*)obj)->x).value);
//         engine_file_write(file_index, buffer, len);

//         len = snprintf(buffer, BUFFER_LENGTH_MAX, "%.09f ", ((mp_obj_float_t)((vector3_class_obj_t*)obj)->y).value);
//         engine_file_write(file_index, buffer, len);

//         len = snprintf(buffer, BUFFER_LENGTH_MAX, "%.09f", ((mp_obj_float_t)((vector3_class_obj_t*)obj)->z).value);
//         engine_file_write(file_index, buffer, len);
...
//         len = snprintf(buffer, BUFFER_LENGTH_MAX, "%.09f ", ((mp_obj_float_t)((color_class_obj_t*)obj)->r).value);
//         engine_file_write(file_index, buffer, len);

//         len = snprintf(buffer, BUFFER_LENGTH_MAX, "%.09f ", ((mp_obj_float_t)((color_class_obj_t*)obj)->g).value);
//         engine_file_write(file_index, buffer, len);

//         len = snprintf(buffer, BUFFER_LENGTH_MAX, "%.09f", ((mp_obj_float_t)((color_class_obj_t*)obj)->b).value);
//         engine_file_write(file_index, buffer, len);
...
//                 if(restore_index >= BUFFER_LENGTH_MAX){
