...
STATIC const physics_manifold_class_obj_t const_separated_manifold = {{&physics_manifold_class_type}, (mp_float_t)0.0, (mp_float_t)0.0, (mp_float_t)NAN, (mp_float_t)NAN, (mp_float_t)0.0, (mp_float_t)0.0, NULL, NULL};
