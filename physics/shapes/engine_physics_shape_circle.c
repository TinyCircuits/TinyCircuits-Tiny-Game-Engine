...
STATIC void physics_shape_circle_class_print(const mp_print_t *print, mp_obj_t self_in, mp_print_kind_t kind){
    physics_shape_circle_class_obj_t *self = self_in;
...
const mp_obj_type_t physics_shape_circle_class_type = {
    { &mp_type_type },
    .name = MP_QSTR_PhysicsShapeCircle,
    ...
    .iternext = NULL,
    .buffer_p = {NULL},
    .locals_dict = (mp_obj_dict_t*)&physics_shape_circle_class_locals_dict,
};
