...
print(engine_physics.get_gravity())
...
class Game(Rectangle2DNode):
    ...
    def tick(self, dt):
        ...
        if self.elapsed_time >= 1.0:
            ...
            self.fps_counter.text = f"{int(fps)}"
            self.frame_count = 0
            self.elapsed_time = 0
        ...
        with game_state_lock:
            ...
            if self.check_win(1,self.grid):
                ...
                self.print_grid()  # Print grid for debugging
                return
    ...
    def ai_move(self):
        ...
        print(f"AI planned move: {planned_ai_move}")
